...
'''
class Solution:
    def traverseLeft(self, curr, result):
        while curr:
    ...
    def traverseRight(self, curr, result):
        temp = []
    ...
    def printBoundaryView(self, root):
        ...
        self.traverseLeft(curr1.left, result)
        self.traverseLeaves(curr2, result)
        self.traverseRight(curr3.right, result)
